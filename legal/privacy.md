# Privacy Policy — fmm-fairness-eval

**Last updated:** 2026-05-20.

This policy describes how César Pereiro García (the "Provider", "we") processes personal data in connection with fmm-fairness-eval ("the Service"). It is intended to comply with Regulation (EU) 2016/679 (GDPR) and Spanish Ley Orgánica 3/2018 (LOPDGDD).
...
Model prediction CSVs supplied by the customer (predicted label, true label, demographic / site / device group identifiers). The Service is built to operate on aggregated predictions, not raw clinical data; we ask customers not to ship raw images, raw clinical notes, or directly identifying patient fields. Hosted CI payloads are deleted within 30 days of the run unless pinned. Customer account data is processed by Stripe.
